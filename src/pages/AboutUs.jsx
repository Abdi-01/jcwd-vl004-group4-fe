...
const AboutUs = () => {
  return (
    <div style={{ marginTop: "70px" }}>
      ...
      >
        Pharmadika is Globally Present to Make People <br />
      ...
      <p style={{ fontSize: "18px", padding: "50px" }}>
        Pharmadika offers over-the-counter drugs with therapeutic benefits.
        We produce consumer products with health benefits, including supplements
        and other preventive products. Pharmadika's over-the-counter
        ...
        <br />
        <br />
        Innovation is the key to Pharmadika, and we adhere to our
